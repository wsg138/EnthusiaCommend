...
# Replace every score-value ternary, including existing/own/commendation variables.
...
if replacements < 4:
    raise SystemExit(f"expected at least 4 weighted-value replacements, found {replacements}")
