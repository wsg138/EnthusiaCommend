...
1. Give a player +30 overall score and -10 in Spawn Killed through actual entries. Confirm warzone glow and a 140% EnthusiaTeleport warmup despite positive overall score. Spawn and duels must not glow. At -12 category score, stalking should be available.
2. Confirm positive teleport tiers at +5/+10/+15/+20, and negative tiers at -10/-15/-25. Check that teleport cooldown is unchanged. With default rules, potion duration, pearl/wind cooldowns, firework duration, and movement must be unchanged, and no cashback is displayed or paid.
